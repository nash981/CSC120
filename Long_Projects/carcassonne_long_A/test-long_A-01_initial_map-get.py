...
print("Checking the 4 tiles adjacent to the start, which are all supposed to be empty...")
print(f"  (1,0): {game.get(1,0)}")
print(f"  (-1,0): {game.get(-1,0)}")
print(f"  (0,1): {game.get(0,1)}")
print(f"  (0,-1): {game.get(0,-1)}")
print()

print("Getting the starting tile...")
the_tile = game.get(0,0)
print()



print("-----------------------------------------------------")
print("We will now dump out the starting tile, the same way that we do the per-tile testcases in this part of the project...")
print()
