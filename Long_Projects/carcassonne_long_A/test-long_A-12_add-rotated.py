...
print(f"  add() returned: {game.add( 1, 0, carcassonne_tile.tile11.rotate().rotate())}")
print(f"  add() returned: {game.add( 1,-1, carcassonne_tile.tile05)}")
print(f"  add() returned: {game.add( 1, 1, carcassonne_tile.tile06)}")
print(f"  add() returned: {game.add(-1, 0, carcassonne_tile.tile01)}")
print(f"  add() returned: {game.add( 2, 0, carcassonne_tile.tile11.rotate().rotate().rotate())}")
print(f"  add() returned: {game.add( 0,-1, carcassonne_tile.tile04.rotate())}")
print()
