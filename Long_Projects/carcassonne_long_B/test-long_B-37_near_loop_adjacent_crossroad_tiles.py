...
game.add( 1,-1, carcassonne_tile.tile10)
game.add( 2,-1, carcassonne_tile.tile03)
...
print(f"  t_r_o_d(0,0,E) returned: {game.trace_road(0,0,E)}")
print(f"  t_r_o_d(0,0,W) returned: {game.trace_road(0,0,W)}")
print(f"  t_r_o_d(1,0,E) returned: {game.trace_road(1,0,E)}")
print(f"  t_r_o_d(2,0,W) returned: {game.trace_road(2,0,W)}")
