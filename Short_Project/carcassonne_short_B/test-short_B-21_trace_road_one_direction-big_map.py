...
print(f"  t_r_o_d(-1, 0,W) returned: {game.trace_road_one_direction(-1, 0,W)}")
print(f"  t_r_o_d( 2, 2,E) returned: {game.trace_road_one_direction( 2, 2,E)}")
print(f"  t_r_o_d( 3, 2,W) returned: {game.trace_road_one_direction( 3, 2,W)}")
