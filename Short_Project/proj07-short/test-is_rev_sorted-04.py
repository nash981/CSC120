...
""" Code to test the is_rev_sorted() function
...
vals  = [('nbj', 18), ('nsn', 39), ('swc', 11), ('qkh', 24), ('ytj', 22)][::-1]
...
###########################################################
def main():
    print("Testing is_rev_sorted()...")
    print()
    print(f"Input list: {in_list}")

    retval = linked_list_recursion_short.is_rev_sorted(in_list)
